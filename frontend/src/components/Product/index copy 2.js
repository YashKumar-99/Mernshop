...
import { Container, Box, Grid, Button, ButtonGroup, CircularProgress } from '@mui/material'; // Import CircularProgress from MUI
    ...
    return (
        <>
            <Container>
                ...
                {loading && <div className="loader-wrapper"><CircularProgress /></div>} {/* Display CircularProgress while loading */}
